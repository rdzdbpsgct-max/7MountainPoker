...
const de = {
  ...
  'app.startingChipsMustBePositive': 'Startchips müssen größer als 0 sein',
  'app.bountyAmountMustBePositive': 'Bounty-Betrag muss größer als 0 sein',
  'app.blindsNotMonotonic': 'Blinds müssen aufsteigend sein (Level {n}: BB {bb} ist nicht größer als vorheriges BB {prevBb})',
  'app.payoutPlacesNotContiguous': 'Auszahlungsplätze müssen lückenlos sein (1, 2, 3, …)',
  ...
  'paywall.feature.customAccent': 'Akzentfarben',
  'paywall.feature.customBackground': 'Hintergrundbilder',
  'paywall.feature.customLayout': 'Display-Layouts',
  'paywall.feature.customAudio': 'Eigene Ansagen',
  'paywall.feature.pdfExport': 'PDF-Export',
  'paywall.feature.series': 'Turnier-Serien',
  'paywall.feature.icmCalculator': 'ICM-Rechner',
  ...
  'history.clone': 'Wiederholen',
  'history.cloneTooltip': 'Turnier mit gleichen Einstellungen neu starten',
  'history.cloneSuccess': 'Turnierconfig geladen — Spieler und Blinds übernommen',
  ...
  'multiTable.balancePreview': 'Vorschau: Tische ausgleichen',
  'multiTable.balancePreviewDesc': '{n} Spieler werden umgesetzt:',
  'multiTable.balanceNoMoves': 'Tische sind bereits ausgeglichen.',
  'multiTable.balanceApply': 'Anwenden',
  'multiTable.balanceCancel': 'Abbrechen',
  'multiTable.balanceMoveDesc': '{player}: {fromTable} Platz {fromSeat} → {toTable} Platz {toSeat}',
  ...
  // --- ICM Calculator ---
  'icm.title': 'ICM-Rechner',
  'icm.close': 'Schließen',
  'icm.description': 'Das Independent Chip Model (ICM) berechnet den fairen Turnierwert jedes Spielers basierend auf Chipstacks und Auszahlungsstruktur.',
  'icm.prizePool': 'Preispool',
  'icm.totalChips': 'Chips gesamt',
  'icm.playerStacks': 'Spieler-Stacks',
  'icm.noStacksHint': 'Keine Stacks erfasst — bitte manuell eingeben.',
  'icm.noPayoutHint': 'Keine Auszahlungsstruktur konfiguriert. ICM benötigt eine Preisverteilung.',
  'icm.results': 'ICM-Equity',
  'icm.player': 'Spieler',
  'icm.chips': 'Chips',
  'icm.chipPercent': 'Chip-%',
  'icm.equity': 'Equity',
  'icm.equityPercent': 'Equity-%',
  'icm.note': 'ICM-Equity unterscheidet sich von der reinen Chip-Verteilung, da die Auszahlungsstruktur nicht linear ist.',

  // --- Tournament Timeline ---
  'timeline.title': 'Turnier-Zeitstrahl',
  'timeline.close': 'Schließen',
  'timeline.empty': 'Noch keine Ereignisse.',
  'timeline.eventCount': '{n} Ereignisse',
  'timeline.filter.all': 'Alle',
  'timeline.filter.players': 'Spieler',
  'timeline.filter.timer': 'Timer',
  'timeline.filter.tables': 'Tische',
  'timeline.event.started': 'Turnier gestartet',
  'timeline.event.finished': 'Turnier beendet',
  'timeline.event.eliminated': '{name} ausgeschieden',
  'timeline.event.reinstated': '{name} zurückgesetzt',
  'timeline.event.rebuy': '{name} — Rebuy',
  'timeline.event.addon': '{name} — Add-On',
  'timeline.event.lateReg': '{name} — Nachmeldung',
  'timeline.event.reEntry': '{name} — Re-Entry',
  'timeline.event.levelStart': 'Level: {level}',
  'timeline.event.levelSkip': 'Level vorgesprungen',
  'timeline.event.levelBack': 'Level zurückgesprungen',
  'timeline.event.paused': 'Timer pausiert',
  'timeline.event.resumed': 'Timer fortgesetzt',
  'timeline.event.tableMove': '{name} — Tischwechsel',
  'timeline.event.tableDissolved': 'Tisch aufgelöst',
  'timeline.event.dealerAdvanced': 'Dealer weitergerückt',
  'timeline.event.clockStarted': 'Call the Clock gestartet',
  'timeline.event.clockExpired': 'Call the Clock abgelaufen',
  'timeline.event.breakExtended': 'Pause verlängert',
  'timeline.event.breakSkipped': 'Pause übersprungen',
  ...
  'sidePot.quickMode': 'Schnellmodus',
  'sidePot.advancedMode': 'Erweitert',
  'sidePot.quickNoStacks': 'Keine Stacks verfügbar. Stacks im Spieler-Panel initialisieren.',
  'sidePot.quickSelectPlayers': 'Wähle die Spieler aus, die in der Hand sind:',
  'sidePot.quickSelectPlayer': 'Spieler in Hand aufnehmen',
  'sidePot.quickDeselectPlayer': 'Spieler aus Hand entfernen',
  'sidePot.quickToggleAllIn': 'All-In umschalten',
  'sidePot.quickStillPlaying': 'Aktiv',
  'sidePot.quickAllIn': 'All-In',
  ...
  'league.creation.title': 'Neue Liga erstellen',
  'league.creation.presets': 'Vorlagen',
  'league.creation.addPlace': 'Platz hinzufügen',
  'league.creation.nameRequired': 'Bitte einen Liga-Namen eingeben',
  'league.creation.rankingHint': 'ELO und Gewichtete Punkte für erweiterte Wertungen — konfigurierbar in den Einstellungen',
  'league.preset.standard': 'Standard',
  'league.preset.simple': 'Einfach',
  'league.preset.top10': 'Top 10',
  'league.tabs.h2h': 'H2H',
  'league.tabs.charts': 'Charts',
  'league.charts.points': 'Punkte-Verlauf',
  'league.charts.placement': 'Platzierungen',
  'league.charts.balance': 'Bilanz',
  'league.charts.yPoints': 'Punkte (kumulativ)',
  'league.charts.yPlace': 'Platz',
  'league.charts.yBalance': 'Bilanz',
  'league.charts.needMoreData': 'Mindestens 2 Spieltage nötig für Diagramme.',
...
const en: Record<TranslationKey, string> = {
  ...
  'app.startingChipsMustBePositive': 'Starting chips must be greater than 0',
  'app.bountyAmountMustBePositive': 'Bounty amount must be greater than 0',
  'app.blindsNotMonotonic': 'Blinds must be ascending (Level {n}: BB {bb} is not greater than previous BB {prevBb})',
  'app.payoutPlacesNotContiguous': 'Payout places must be contiguous (1, 2, 3, …)',
  ...
  'paywall.feature.customAccent': 'Accent colors',
  'paywall.feature.customBackground': 'Backgrounds',
  'paywall.feature.customLayout': 'Display layouts',
  'paywall.feature.customAudio': 'Custom announcements',
  'paywall.feature.pdfExport': 'PDF export',
  'paywall.feature.series': 'Tournament series',
  'paywall.feature.icmCalculator': 'ICM calculator',
  'paywall.feature.cloudBackup': 'Cloud backup',
  ...
  'history.clone': 'Repeat',
  'history.cloneTooltip': 'Start a new tournament with the same settings',
  'history.cloneSuccess': 'Tournament config loaded — players and blinds applied',
  ...
  'event.rebuyTaken': '🔄 {name} Rebuy',
  'event.addonTaken': '➕ {name} Add-On',
  'event.levelStart': '▶ Level {level} started',
  'event.timerPaused': '⏸ Timer paused',
  'event.timerResumed': '▶ Timer resumed',
  'event.breakExtended': '☕ Break extended (+{seconds}s)',
  'event.breakSkipped': '⏭ Break skipped',
  'event.tournamentStarted': '🃏 Tournament started',
  'event.tournamentFinished': '🏆 Tournament finished',
  'event.playerReinstated': '↩ {name} reinstated',
  'event.lateRegistration': '📝 {name} late registration',
  'event.reEntry': '🔁 {name} Re-Entry',
  'event.dealerAdvanced': '🎯 Dealer advanced',
  'event.tableMove': '🔀 {name} table move',
  'event.tableDissolved': '🚫 Table {table} dissolved',
  'event.callTheClockStarted': '⏱ Call the Clock started',
  ...
  'multiTable.balancePreview': 'Preview: Balance Tables',
  'multiTable.balancePreviewDesc': '{n} players will be moved:',
  'multiTable.balanceNoMoves': 'Tables are already balanced.',
  'multiTable.balanceApply': 'Apply',
  'multiTable.balanceCancel': 'Cancel',
  'multiTable.balanceMoveDesc': '{player}: {fromTable} Seat {fromSeat} → {toTable} Seat {toSeat}',
  ...
  // --- ICM Calculator ---
  'icm.title': 'ICM Calculator',
  'icm.close': 'Close',
  'icm.description': 'The Independent Chip Model (ICM) calculates each player\'s fair tournament value based on chip stacks and payout structure.',
  'icm.prizePool': 'Prize Pool',
  'icm.totalChips': 'Total Chips',
  'icm.playerStacks': 'Player Stacks',
  'icm.noStacksHint': 'No stacks tracked — please enter manually.',
  'icm.noPayoutHint': 'No payout structure configured. ICM requires a prize distribution.',
  'icm.results': 'ICM Equity',
  'icm.player': 'Player',
  'icm.chips': 'Chips',
  'icm.chipPercent': 'Chip %',
  'icm.equity': 'Equity',
  'icm.equityPercent': 'Equity %',
  'icm.note': 'ICM equity differs from pure chip distribution because the payout structure is non-linear.',

  // --- Tournament Timeline ---
  'timeline.title': 'Tournament Timeline',
  'timeline.close': 'Close',
  'timeline.empty': 'No events yet.',
  'timeline.eventCount': '{n} events',
  'timeline.filter.all': 'All',
  'timeline.filter.players': 'Players',
  'timeline.filter.timer': 'Timer',
  'timeline.filter.tables': 'Tables',
  'timeline.event.started': 'Tournament started',
  'timeline.event.finished': 'Tournament finished',
  'timeline.event.eliminated': '{name} eliminated',
  'timeline.event.reinstated': '{name} reinstated',
  'timeline.event.rebuy': '{name} — Rebuy',
  'timeline.event.addon': '{name} — Add-On',
  'timeline.event.lateReg': '{name} — Late registration',
  'timeline.event.reEntry': '{name} — Re-Entry',
  'timeline.event.levelStart': 'Level: {level}',
  'timeline.event.levelSkip': 'Level skipped forward',
  'timeline.event.levelBack': 'Level skipped backward',
  'timeline.event.paused': 'Timer paused',
  'timeline.event.resumed': 'Timer resumed',
  'timeline.event.tableMove': '{name} — Table move',
  'timeline.event.tableDissolved': 'Table dissolved',
  'timeline.event.dealerAdvanced': 'Dealer advanced',
  'timeline.event.clockStarted': 'Call the Clock started',
  'timeline.event.clockExpired': 'Call the Clock expired',
  'timeline.event.breakExtended': 'Break extended',
  'timeline.event.breakSkipped': 'Break skipped',
  ...
  'sidePot.quickMode': 'Quick Mode',
  'sidePot.advancedMode': 'Advanced',
  'sidePot.quickNoStacks': 'No stacks available. Initialize stacks in the Player Panel.',
  'sidePot.quickSelectPlayers': 'Select the players who are in the hand:',
  'sidePot.quickSelectPlayer': 'Include player in hand',
  'sidePot.quickDeselectPlayer': 'Remove player from hand',
  'sidePot.quickToggleAllIn': 'Toggle all-in',
  'sidePot.quickStillPlaying': 'Playing',
  'sidePot.quickAllIn': 'All-In',
  ...
  'league.creation.title': 'Create New League',
  'league.creation.presets': 'Presets',
  'league.creation.addPlace': 'Add place',
  'league.creation.nameRequired': 'Please enter a league name',
  'league.creation.rankingHint': 'ELO and Weighted Points for advanced rankings — configurable in settings',
  'league.preset.standard': 'Standard',
  'league.preset.simple': 'Simple',
  'league.preset.top10': 'Top 10',
  'league.tabs.h2h': 'H2H',
  'league.tabs.charts': 'Charts',
  'league.charts.points': 'Points Trend',
  'league.charts.placement': 'Placements',
  'league.charts.balance': 'Balance',
  'league.charts.yPoints': 'Points (cumulative)',
  'league.charts.yPlace': 'Place',
  'league.charts.yBalance': 'Balance',
  'league.charts.needMoreData': 'At least 2 game days needed for charts.',
