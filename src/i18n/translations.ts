...
const de = {
  ...
  'tour.step5.desc': 'Starte das Turnier! Im Spiel: Space = Pause, N = nächstes Level, T = TV-Modus.',
...
const en: Record<TranslationKey, string> = {
  ...
  'tour.step5.desc': 'Start the tournament! In game: Space = Pause, N = Next Level, T = TV Mode.',
  'tour.skip': 'Skip',
  'tour.prev': 'Back',
  'tour.next': 'Next',
